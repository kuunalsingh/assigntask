...
if [ $option -gt 11 ]
    ...
    then 
        echo "Option Selected: " $option
        sleep 2
         gsutil mb -c standard -l asia-south1 --retention 30m gs://kunal11221212
        echo -e "Bucket Created\n"
        sleep 10
        echo -e "Adding a basic html"
        gsutil cp -r html gs://kunal11221212
        sleep 10
    ...
    then 
        echo "Option Selected: " $option
        sleep 2
        gsutil -m acl ch -R -u AllUsers:R gs://kunal11221212/html
    ...
    then 
        echo "Option Selected: " $option
        sleep 2
        gsutil retention set 60s gs://kunal11221212
